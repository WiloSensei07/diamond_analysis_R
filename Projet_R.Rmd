...
Le critère BIC suggère que les variables les plus pertinentes de ce modèle sont carat, depth, table, x et y. Le modèle est significatif (p-value: < 2.2e-16) et explique 85.92% de la variation du prix des diamants (Adjusted R-squared:  0.8592).
